...
public class Main
{
	...
	public static void main(String[] args) {
		...
		String javaCode2 = "System.out.print(\"Enter a number (((even or odd ): \"); "
		...
		System.out.println(checker.isCorrect(javaCode2));
		System.out.println(checker.isCorrect(javacode3));
		System.out.println(checker.isCorrect(tst1));
		System.out.println(checker.isCorrect(tst2));
		System.out.println(checker.isCorrect(tst3));
		System.out.println(checker.isCorrect(tst4));
	}
